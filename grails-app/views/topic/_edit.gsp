<div class="modal fade" tabindex="-1" role="dialog" id="topicedit">
    <div class="modal-dialog">
        <div class="modal-content">
            <form class="form-horizontal" id="formcreatetopic" action="topic/update" method="post">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" target-form="formcreatetopic">Update</button>
